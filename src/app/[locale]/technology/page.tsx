  ...
  return (
    <>
      ...
      <Section>
        ...
        <div className="space-y-4">
          {dashboardFeatures.map((f, i) => (
            <div
              key={i}
              className="flex items-start gap-4 bg-linear-to-br from-gray-900 to-gray-900/80 border border-gray-800/60 rounded-xl p-6 hover:border-gray-700/80 transition-all duration-200"
            >
      ...
      <Section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={stage.num}
              className="bg-linear-to-br from-gray-900 to-gray-900/80 border border-gray-800/60 rounded-2xl p-8 hover:border-gray-700/80 hover:shadow-lg hover:shadow-brand-glow/5 transition-all duration-300 relative"
            >
      ...
      <Section className="bg-gray-900/30">
        ...
        <div className="bg-linear-to-br from-gray-900 to-gray-900/80 border border-gray-800/60 rounded-2xl p-8 hover:border-gray-700/80 hover:shadow-lg hover:shadow-brand-glow/5 transition-all duration-300 max-w-3xl space-y-3">
          ...
          <table className="w-full text-left">
            <thead className="bg-gray-800/30">
              <tr className="border-b border-gray-700">
                <th className="pb-4 pt-4 px-6 text-gray-400 text-xs font-semibold uppercase tracking-wider">
                  Component
                </th>
                <th className="pb-4 pt-4 px-6 text-gray-400 text-xs font-semibold uppercase tracking-wider">
                  Technology
                </th>
                <th className="pb-4 pt-4 px-6 text-gray-400 text-xs font-semibold uppercase tracking-wider">Why</th>
              </tr>
            </thead>
            <tbody>
              {infraItems.map((row, i) => (
                <tr key={i} className="border-b border-gray-800/50 hover:bg-gray-800/20 transition-colors">
                  ...
                  <td className="py-4 px-6 text-brand font-mono text-sm">
                    {row.tech}
                  </td>
                  <td className="py-4 px-6 text-gray-400 text-sm">{row.why}</td>
                </tr>
              ))}
            </tbody>
          </table>
